...
describe('KeyedSeq', function () {
    check.it('it iterates equivalently', [gen.array(gen.int)], function (ints) {
        var seq = immutable_1.Seq(ints);
    ...
    it('works with reverse', function () {
        var seq = immutable_1.Range(0, 100);
        // This is what we expect for IndexedSequences
    ...
    it('works with double reverse', function () {
        var seq = immutable_1.Range(0, 100);
        // This is what we expect for IndexedSequences
